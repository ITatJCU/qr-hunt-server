...
/**
 * Flags a player as a previous round winner
 *
 * @method setWinner
 * @param {number} uuid Player UUID to flag as winner
 * @param {Function} [callback] Callback function
 * @param {number} callback.player Found Player reference
 * @param {Object} callback.err Callback err or null
 */
PlayerDAO.prototype.setWinner = function (uuid, callback) {
    throw new Error("Method Not Implemented");
};


/**
 * Removes a winner flag from a player
 *
 * @method removeWinner
 * @param {number} uuid Player UUID to flag as winner
 * @param {Function} [callback] Callback function
 ...
 * @param {Object} callback.err Callback err or null
 */
PlayerDAO.prototype.removeWinner = function (uuid, callback) {
    throw new Error("Method Not Implemented");
};
/**
...
/**
 * Adds a QR code scan to a specified player uuid
 *
 * @method addScan
 * @param {number} uuid Player UUID to associate
 * @param {number} scanId Scan id to add
 * @param {Function} [callback] Callback function
 * @param {Object} callback.player Updated player object
 * @param {Object} callback.err Callback err or null
 */
PlayerDAO.prototype.addScan = function (uuid, scanId, callback) {
    throw new Error("Method Not Implemented");
};

/**
 * Gets the current game leaderboard
 *
 * @method leaderboard
 * @param {Function} [callback] Callback function
 * @param {Object} callback.player Updated player object
 * @param {Object} callback.err Callback err or null
 */
PlayerDAO.prototype.leaderboard = function (callback) {
    throw new Error("Method Not Implemented");
};
